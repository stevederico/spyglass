...
/** Props for the Filmstrip slot navigator. */
 ...
 */
const ThumbnailCard = React.memo(function ThumbnailCard({ slot, index, isActive, isOnly, onSelect, onRemove, onDuplicate }: ThumbnailCardProps) {
  ...
  /** @param e - Keyboard event on the thumbnail */
...
export default function Filmstrip({ slots, activeIndex, onSelect, onRemove, onDuplicate, onAdd }: FilmstripProps) {
