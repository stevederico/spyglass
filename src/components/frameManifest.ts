...
/** A selectable color variant for a device frame. */
export interface FrameColor {
  slug: string;
  label: string;
}

/** Definition of a device frame: dimensions, screen inset, ASC tier, and colors. */
...
/** Device frame manifest keyed by model slug. */
